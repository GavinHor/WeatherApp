...
export default class Iphone extends Component {
	...
	constructor(props) {
		...
		this.setState({
			...
			displayWeekly: false,
			displayError: false,
			displaysToggle: false,
			settingsTrueFalse: [false, false],
			displayAdvancedToggle: false,
			advancedTrueFalse: [false, false],
	...
	render() {
		...
		return (
			<body class={style.container}>
				...
				{this.state.displayAdvancedToggle ? <AdvancedPage updateAdvanced={this.updateAdvanced}/>: null}
				...
				<footer class={style.footer}>
					...
					<AdvancedButton clickFunction={this.displayAdvanced} />
				</footer>
			</body>
		);
	}
	...
	//Sets relevant display fields as true, and others as false
	displaySettings = () => {
	...
	//Sets relevant display fields as true, and others as false
	displayAdvanced = () => {
		console.log('displayAdvanced() is toggled');
		if (this.state.displayError == true)
		{
			return;
		}
		if (this.state.displayAdvancedToggle == true) {
			this.setState({
				displaySettingsToggle: false,
				displayAdvancedToggle: false,
				displayHourly: true,
			...
			this.setState({
				displaySettingsToggle: false,
				displayAdvancedToggle: true,
				displayHourly: false,
				displayWeekly: false
			});
		}
		console.log("Advanced displayed?: " + this.state.displayAdvancedToggle);
	}
	...
	updateAdvanced = (trueFalse) => {
		console.log(trueFalse);
		this.setState({
			advancedTrueFalse: trueFalse
		});
	}
}
